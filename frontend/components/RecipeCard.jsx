...
const RecipeCard = ({ recipe, variant = "default" }) => {
  ...
  if (variant === "grid") {
    return (
      <Link href={data.href}>
        <Card
          className="rounded-none overflow-hidden botrder-stone-200 hover:shadow-xl
        ...
        >
          ...
          <CardHeader>
            <CardTitle
              className="textlg font-bold text-stone-900
            ...
            <div className="flex-1">
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                {data.category && (
                  <Badge
                    variant="outline"
                    className="text-stone-600 botrder-stone-200 capitalize"
                  >
                    {data.category}
                  </Badge>
                )}
  ...
  if (variant === "list") {
    return (
      <Link href={data.href}>
        <Card
          className="rounded-none border-stone-200 hover:shadow-lg hover:border-orange-200
        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            {data.showImage ? (
              ...
              <div
                className="relative w-full md:w-48 aspect-video md:aspect-square flex-shrink-0
             bg-linear-to-br from-orange-400 to-amber-400 items-center justify-center"
              >
            ...
            <div className="flex-1 py-5">
              <CardHeader>
                ...
                <CardTitle
                  className="text-xl font-bold text-stone-900 group-hover:text-orange-600
                  transition-colors"
                >
                  {data.title}
                </CardTitle>
