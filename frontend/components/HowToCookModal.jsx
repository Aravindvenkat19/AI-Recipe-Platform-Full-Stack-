  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
         <button className="hover:text-orange-600 transition-colors flex items-center gap-1.5 text-sm
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-6">
          <div>
            ...
            <div className="relative">
               <input
                 ...
                 className="w-full px-4 py-3 pr-12 border border-stone-200 rounded-xl focus:outline-none
                 focus:ring-2 focus:ring-orange-500 text-stone-900 placeholder:text-stone-400"
                 autoFocus
               />
         ...
         <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
           ...
           <div className="flex flex-wrap gap-2">
             {["Butter Chicken", "Chocolate Browines", "Caesar Salad"].map(
                (example) => (
                    <button
                      key={example}
                      type="button"
                      onClick={() => setRecipeName(example)}
                      className="px-3 py-1 bg-white text-orange-700 border border-orange-200 rounded-full
                      text-sm hover:bg-orange-100 transition-colors"
                    >
                       {example}
                    </button>
                ),
