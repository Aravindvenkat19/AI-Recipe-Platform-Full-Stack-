    ...
    return (
      <div className="min-h-screen bg-stone-50 pt-24 pb-16">
        <div className="container mx-auto max-w-4xl text-center py-20">
          <div
            className="bg-orange w-20 h-20 border-2 border-orange-200 flex
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="flex justify-between items-start gap-2 text-stone-700 py-2 border-b
                           border-stone-100 last:border-0"
                      >
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div
                      className="absolute -left-5 top-0 w-10 h-10 bg-orange-600 text-white flex
                          items-center justify-center font-bold border-2 border-orange-700"
                    >
                      {step.step}
                    </div>
              ...
              <div
                className="mt-8 p-6 bg-linear-to-br from-green-50 to-emerald-50 border-2
                   border-green-200"
              >
                <div className="flex ietms-start gap-3">
            ...
            {recipe.tips && recipe.tips.length > 0 && (
              <div
                className="bg-gradient-to-br from-orange-50 to-amber-50 p-8 border-2 
                    border-orange-200"
              >
                <h2 className="text-2xl font-bold text-stone-900 mb-4 flex items-center gap-2">
            ...
            {recipe.substitutions && recipe.substitutions.length > 0 && (
              <div className="bg-white p-8 border-2 border-stone-200">
                <h2 className="text-2xl font-bold text-stone-900 mb-4 flex items-center gap-2">
                  ...
                  {!recipeData.isPro && (
                    <span
                      className="text-xs bg-orange-100 text-orange-700 px-2 py-0.5
                ...
                >
                  <div className="space-y-4">
                    {recipe.substitutions.map((sub, i) => (
                      <div
                        key={i}
                        className="border-b-2 border-stone-100 pb-4 last:border-0
                                  last:pb-0"
                      >
