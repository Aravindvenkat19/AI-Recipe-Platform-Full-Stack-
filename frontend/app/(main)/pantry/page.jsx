        ...
        <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
               ...
               <div className="mb-4">
                  ...
                  <Button onClick={()=> setIsModalOpen(true)} className="hidden md:flex" size="lg" variant="primary" >
                   ...
                   {itemsData?.scansLimit !== undefined && (
                     <div className="bg-white py-3 px-4 border-2 border-stone-200 inline-flex items-center">
               ...
               <Link href={"/pantry/recipes"} className="block mb-8">
                  ...
                  border-emerald-700 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group">
                     <div className="flex items-center gap-4">
                        <div className="bg-white/20 p-3 border-2 border-white/30 group-hover:bg-white/30
                        transition-colors">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="hidden sm:block">
                            <Badge className="bg-white/20 text-white border-2 border-white/30 font-bold uppercase
                            tracking-wide">
                              {items.length} items
                            </Badge>
                          </div>
            ...
            {!loadingItems && items.length > 0 && (
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                   {items.map((item)=>(
                     <div
                      key={item.documentId}
                      className="bg-white p-5 border-2 border-stone-200 hover:border-orange-600
                           ...
                           <div className="space-y-3">
                              ...
                              <div className="flex gap-2">
                                 <Button
                                   ...
                                   onClick={saveEdit}
                                   disabled={updating}
                                   className="flex-1 bg-green-600 hover:bg-green-700 border-2 border-green-70"
                                 >
                                    {updating ? (
            ...
            {!loadingItems  && items.length === 0 && (
               <div className="bg-white p-12 text-center border-2 border-dashed border-stone-200">
                  <div className="bg-orange-50 w-20 h-20 border-2 border-orange-200 flex items-center
