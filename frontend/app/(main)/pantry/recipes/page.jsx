    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center gap-2 text-stone-600
              hover:text-orange-600 transition-colors mb-4 font-medium"
          >
          ...
          {recipesData !== undefined && (
            <div
              className="bg-orange-50 p-4 border-2 border-orange-200 inline-flex
                  items-center gap-3"
            >
        ...
        {!loading && recipes.length === 0 && recipesData?.success === false && (
          <div
            className="bg-white p-12 text-center border-2 border-dashed
              border-stone-200"
          >
            <div
        ...
        {!loading && recipesData === undefined && (
          <div
            className="bg-linear-to-br form-orange-50 to-amber-50 p-12 text-center
             border-2 border-orange-200"
          >
            <div
              className="bg-orange-100 w-20 h-20 border-2 border-orange-200 flex
                items-center justify-center mx-auto mb-6"
            >
